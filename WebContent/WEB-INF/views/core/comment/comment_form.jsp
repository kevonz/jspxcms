...
<div class="c_bar">
  <span class="c_position"><s:message code="comment.management"/> - <s:message code="${oprt=='edit'?'edit':'create'}"/></span>
</div>
...
<table border="0" cellpadding="0" cellspacing="0" class="in_tb">
  ...
  <tr>
    <td class="in_lab" width="15%"><s:message code="comment.info"/>:</td>
    <td class="in_ctt" width="85%" colspan="3"><f:text value="${bean.anchor.title}" readonly="readonly" style="width:500px;"/></td>
  </tr>
  <tr>
    <td class="in_lab" width="15%"><s:message code="comment.creator"/>:</td>
    <td class="in_ctt" width="35%"><f:text value="${bean.creator.username}" readonly="readonly" style="width:180px;"/></td>
    <td class="in_lab" width="15%"><em class="required">*</em><s:message code="comment.creationDate"/>:</td>
    <td class="in_ctt" width="35%"><input type="text" name="creationDate" value="<fmt:formatDate value="${bean.creationDate}" pattern="yyyy-MM-dd'T'HH:mm:ss"/>" onclick="WdatePicker({dateFmt:'yyyy-MM-ddTHH:mm:ss'});" class="required" style="width:180px;"/></td>
  </tr>
  <tr>
    <td class="in_lab" width="15%"><em class="required">*</em><s:message code="comment.status"/>:</td>
    ...
    <td class="in_lab" width="15%"><em class="required">*</em><s:message code="comment.ip"/>:</td>
    <td class="in_ctt" width="35%"><f:text name="ip" value="${bean.ip}" readonly="readonly" class="required" style="width:180px;"/></td>
  </tr>
  <tr>
    <td class="in_lab" width="15%"><em class="required">*</em><s:message code="comment.score"/>:</td>
    <td class="in_ctt" width="35%"><f:text name="score" value="${bean.score}" class="required digits" style="width:180px;"/></td>
    <td class="in_lab" width="15%"><s:message code="comment.auditDate"/>:</td>
    <td class="in_ctt" width="35%"><input type="text" name="auditDate" value="<fmt:formatDate value="${bean.auditDate}" pattern="yyyy-MM-dd'T'HH:mm:ss"/>" onclick="WdatePicker({dateFmt:'yyyy-MM-ddTHH:mm:ss'});" style="width:180px;"/></td>
  </tr>
  <tr>
    <td class="in_lab" width="15%"><em class="required">*</em><s:message code="comment.text"/>:</td>
    <td class="in_ctt" width="85%" colspan="3"><f:textarea name="text" value="${bean.text}" style="width:500px;height:120px;"/></td>
  </tr>
  <tr>
    <td colspan="4" class="in_opt">
