...
<div class="c_bar">
  <span class="c_position"><s:message code="model.management"/> - <s:message code="model.type.${model.type}"/> - <s:message code="model.fieldList"/></span>
...
<tags:search_params/>
<div class="ls_bc_opt">
	<div class="ls_btn"><input type="button" value="<s:message code="create"/>" onclick="location.href='create.do?modelId=${model.id}&${searchstring}';"/></div>
	<div class="ls_btn"><input type="button" value="<s:message code="modelField.addPredefinedField"/>" onclick="location.href='predefined_list.do?modelId=${model.id}&${searchstring}';"/></div>
  ...
  <div class="ls_btn"><input type="button" value="<s:message code='moveBottom'/>" onclick="Cms.moveBottom('ids');"/></div>
	<div class="ls_btn"></div>
	<div class="ls_btn"><input type="button" value="<s:message code="return"/>" onclick="location.href='../model/list.do?id=${model.id}&${searchstring}';"/></div>
...
<table id="pagedTable" border="0" cellpadding="0" cellspacing="0" class="ls_tb">
  ...
  <tr beanid="${bean.id}">
    ...
    <td align="center">
      ...
      <a href="delete.do?ids=${bean.id}&modelId=${model.id}&${searchstring}" onclick="return confirmDelete();" class="ls_opt"><s:message code="delete"/></a>
     </td>
