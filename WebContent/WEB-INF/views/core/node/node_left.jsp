...
$(function(){
	$("#showList").prop("checked",$.cookie('show_list')!='false').click(function() {
		$.cookie('show_list',this.checked);
		fireClick();
	});
	$("#showDescendants").prop("checked",$.cookie('show_descendants')=='true').click(function() {
...
<div style="padding:7px 0 3px 0;text-align:center;">
  ...
  <%-- <a href="javascript:location.href=location.href" class="ls_opt"><s:message code="refresh"/></a> &nbsp; --%>
  <%-- <a href="../model/list.do" target="center" class="ls_opt"><s:message code="model.management"/></a> &nbsp; --%>
</div>
<hr/>
