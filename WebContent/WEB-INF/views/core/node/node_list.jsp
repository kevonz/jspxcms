...
<div class="c_bar">
  <span class="c_position"><s:message code="node.management"/> - <s:message code="list"/></span>
...
<form action="list.do" method="get">
    ...
    <legend><s:message code="search"/></legend>
	  <label class="c_lab"><s:message code="node.name"/>: <input type="text" name="search_CONTAIN_name" value="${search_CONTAIN_name[0]}"/></label>
	  <label class="c_lab"><s:message code="node.number"/>: <input type="text" name="search_CONTAIN_number" value="${search_CONTAIN_number[0]}"/></label>
	  <label class="c_lab">
...
<tags:search_params/>
<div class="ls_bc_opt">
	<div class="ls_btn"><input type="button" value="<s:message code="create"/>" onclick="location.href='create.do?parentId=${parent.id}&queryParentId=${queryParentId}&showDescendants=${showDescendants}&${searchstring}';"/></div>
	...
	<div class="ls_btn"><input type="button" value="<s:message code="move"/>" onclick="return optMulti(this.form,'move_input.do?queryParentId=${queryParentId}&showDescendants=${showDescendants}&${searchstring}',true);"/></div>
	<div class="ls_btn"><input type="button" value="<s:message code="delete"/>" onclick="return optDelete(this.form);"/></div>
	<div class="ls_btn"></div>
	<div class="ls_btn"><input type="button" value="<s:message code="node.generatePage"/>" onclick="return optMulti(this.form,'generate_page.do?queryParentId=${queryParentId}&showDescendants=${showDescendants}&${searchstring}');"/></div>
	<div class="ls_btn"><input type="button" value="<s:message code="node.addFulltext"/>" onclick="return optMulti(this.form,'add_fulltext.do?queryParentId=${queryParentId}&showDescendants=${showDescendants}&${searchstring}');"/></div>
	<div class="ls_btn"></div>
...
<table id="pagedTable" border="0" cellpadding="0" cellspacing="0" class="ls_tb">
  ...
  <tr class="ls_table_th">
    ...
    <th class="ls_th_sort"><span class="ls_sort" pagesort="name"><s:message code="node.name"/></span></th>
    <th class="ls_th_sort"><span class="ls_sort" pagesort="number"><s:message code="node.number"/></span></th>
    <th class="ls_th_sort"><span class="ls_sort" pagesort="views"><s:message code="node.views"/></span></th>
  ...
  <tr beanid="${bean.id}">
    ...
    <td align="center">
      <a id="createChild_opt_${bean.id}" href="create.do?parentId=${bean.id}&queryParentId=${queryParentId}&showDescendants=${showDescendants}&${searchstring}" class="ls_opt"><s:message code="node.createChild"/></a>
      <a id="copy_opt_${bean.id}" href="create.do?cid=${bean.id}&queryParentId=${queryParentId}&showDescendants=${showDescendants}&${searchstring}" class="ls_opt"<c:if test="${bean.parent==null}"> disabled="disabled"</c:if>><s:message code="copy"/></a>
      <a id="edit_opt_${bean.id}" href="edit.do?id=${bean.id}&position=${pagedList.number*pagedList.size+status.index}&queryParentId=${queryParentId}&showDescendants=${showDescendants}&${searchstring}" class="ls_opt"><s:message code="edit"/></a>
      <a id="move_opt_${bean.id}" href="move_input.do?ids=${bean.id}&queryParentId=${queryParentId}&showDescendants=${showDescendants}&${searchstring}" class="ls_opt"<c:if test="${bean.parent==null}"> disabled="disabled"</c:if>><s:message code="move"/></a>
      <a href="delete.do?ids=${bean.id}&queryParentId=${queryParentId}&showDescendants=${showDescendants}&${searchstring}" onclick="return confirmDelete();" class="ls_opt"><s:message code="delete"/></a>
     </td>
