...
<div class="c_bar">
  <span class="c_position"><s:message code="node.management"/> - <s:message code="move"/></span>
</div>
...
<table border="0" cellpadding="0" cellspacing="0" class="in_tb">
  ...
  <tr>
  	<th width="50%" align="center" class="in_ctt"><s:message code="node.origNode"/></th>
  	<th width="50%" align="center" class="in_ctt"><s:message code="node.destNode"/></th>
  </tr>
  <tr>
  	<td width="50%" valign="top" class="in_ctt">
  ...
  <tr>
    <td colspan="2" class="in_opt">
      <div class="in_btn"><input type="submit" value="<s:message code="submit"/>"/></div>
      <div style="clear:both;"></div>
    </td>
  </tr>
</table>
