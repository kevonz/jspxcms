...
<div class="c_bar">
  <span class="c_position"><s:message code="org.management"/> - <s:message code="${oprt=='edit'?'edit':'create'}"/></span>
</div>
...
<table border="0" cellpadding="0" cellspacing="0" class="in_tb">
  ...
  <tr>
    <td class="in_lab" width="15%"><em class="required">*</em><s:message code="org.name"/>:</td>
    <td class="in_ctt" width="35%"><f:text name="name" value="${oprt=='edit'?bean.name:''}" class="required" style="width:180px;"/></td>
    <td class="in_lab" width="15%"><s:message code="org.fullName"/>:</td>
    <td class="in_ctt" width="35%"><f:text name="fullName" value="${oprt=='edit'?bean.fullName:''}" style="width:180px;"/></td>
  </tr>
  <tr>
    <td class="in_lab" width="15%"><s:message code="org.description"/>:</td>
    <td class="in_ctt" colspan="3"><f:textarea name="description" value="${bean.description}" class="{maxlength:255}" style="width:500px;height:80px;"/></td>
  </tr>
  <tr>
    <td colspan="4" class="in_opt">
