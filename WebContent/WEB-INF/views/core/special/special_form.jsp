...
<div class="c_bar">
  <span class="c_position"><s:message code="special.management"/> - <s:message code="${oprt=='edit'?'edit':'create'}"/></span>
</div>
...
<table border="0" cellpadding="0" cellspacing="0" class="in_tb">
  ...
  <tr>
    <td class="in_lab" width="15%"><em class="required">*</em><s:message code="special.title"/>:</td>
    <td class="in_ctt" width="85%" colspan="3"><f:text name="title" value="${oprt=='edit'?bean.title:''}" class="required" maxlength="150" style="width:500px;"/></td>
  </tr>
  <tr>
    <td class="in_lab" width="15%"><s:message code="special.metaKeywords"/>:</td>
    <td class="in_ctt" width="85%" colspan="3"><f:text name="metaKeywords" value="${bean.metaKeywords}" class="" maxlength="150" style="width:500px;"/></td>
  </tr>
  <tr>
    <td class="in_lab" width="15%"><s:message code="special.metaDescription"/>:</td>
    <td class="in_ctt" width="85%" colspan="3"><f:textarea name="metaDescription" value="${bean.metaDescription}" maxlength="255" style="width:500px;height:80px;"/></td>
  </tr>
  <tr>
    <td class="in_lab" width="15%"><em class="required">*</em><s:message code="special.category"/>:</td>
    ...
    <td class="in_lab" width="15%"><s:message code="special.creationDate"/>:</td>
    <td class="in_ctt" width="35%"><input type="text" name="creationDate" value="<fmt:formatDate value="${bean.creationDate}" pattern="yyyy-MM-dd'T'HH:mm:ss"/>" onclick="WdatePicker({dateFmt:'yyyy-MM-ddTHH:mm:ss'});" class="${oprt=='edit'?'required':''}" style="width:180px;"/></td>
  </tr>
  <tr>
    <td class="in_lab" width="15%"><em class="required">*</em><s:message code="special.recommend"/>:</td>
    <td class="in_ctt" width="35%">
    ...
    <td class="in_lab" width="15%"><em class="required">*</em><s:message code="special.views"/>:</td>
    <td class="in_ctt" width="35%"><f:text name="views" value="${oprt=='edit'?bean.views:'0'}" class="required digit" style="width:180px;"/></td>
  </tr>
  <tr>
    <td class="in_lab" width="15%"><s:message code="special.smallImage"/>:</td>
    <td class="in_ctt" width="85%" colspan="3">
	    <tags:image_upload name="smallImage" value="${bean.smallImage}"/>
		</td>
	</tr>
  <tr>
    <td class="in_lab" width="15%"><s:message code="special.largeImage"/>:</td>
    <td class="in_ctt" width="85%" colspan="3">
