...
<div class="c_bar">
  <span class="c_position"><s:message code="specialCategory.management"/> - <s:message code="${oprt=='edit'?'edit':'create'}"/></span>
</div>
...
<table border="0" cellpadding="0" cellspacing="0" class="in_tb">
  ...
  <tr>
    <td class="in_lab" width="15%"><em class="required">*</em><s:message code="specialCategory.name"/>:</td>
    <td class="in_ctt" width="35%"><f:text name="name" value="${oprt=='edit'?bean.name:''}" class="required" style="width:180px;"/></td>
    <td class="in_lab" width="15%"><em class="required">*</em><s:message code="specialCategory.views"/>:</td>
    <td class="in_ctt" width="35%"><f:text name="views" value="${oprt=='edit'?bean.views:'0'}" class="required digit" style="width:180px;"/></td>
  </tr>
  <tr>
    <td class="in_lab" width="15%"><s:message code="specialCategory.metaKeywords"/>:</td>
  ...
  <tr>
    <td class="in_lab" width="15%"><s:message code="specialCategory.metaDescription"/>:</td>
    <td class="in_ctt" width="85%" colspan="3"><f:textarea name="metaDescription" value="${bean.metaDescription}" maxlength="255" style="width:500px;height:120px;"/></td>
  </tr>
  <tr>
    <td colspan="4" class="in_opt">
