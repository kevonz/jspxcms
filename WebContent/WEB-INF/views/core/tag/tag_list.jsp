...
<div class="c_bar">
  <span class="c_position"><s:message code="tag.management"/> - <s:message code="list"/></span>
...
<form action="list.do" method="get">
    ...
    <legend><s:message code="search"/></legend>
	  <label class="c_label"><s:message code="tag.name"/>: <input type="text" name="search_CONTAIN_name" value="${search_CONTAIN_name[0]}"/></label>
...
<table id="pagedTable" border="0" cellpadding="0" cellspacing="0" class="ls_tb">
  ...
  <tr class="ls_table_th">
    ...
    <th class="ls_th_sort"><span class="ls_sort" pagesort="name"><s:message code="tag.name"/></span></th>
    <th class="ls_th_sort"><span class="ls_sort" pagesort="refers"><s:message code="tag.refers"/></span></th>
    <th class="ls_th_sort"><span class="ls_sort" pagesort="creationDate"><s:message code="tag.creationDate"/></span></th>
  </tr>
  </thead>
  <tbody>
