...
<div class="c_bar">
  <span class="c_position"><s:message code="user.management"/> - <s:message code="${oprt=='edit'?'edit':'create'}"/></span>
</div>
...
<table border="0" cellpadding="0" cellspacing="0" class="in_tb">
  ...
  <tr>
    ...
    <td class="in_ctt" colspan="3"><f:text name="username" value="${oprt=='edit'?bean.username:''}" class="{required:true,remote:'check_username.do?original=${oprt=='edit'?bean.username:''}'}" style="width:180px;"/></td>
  </tr>
  <tr>
