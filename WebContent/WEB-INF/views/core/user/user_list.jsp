...
<div class="c_bar">
  <span class="c_position"><s:message code="user.management"/> - <s:message code="list"/></span>
...
<form action="list.do" method="get">
    ...
    <legend><s:message code="search"/></legend>
	  <label class="c_lab"><s:message code="user.username"/>: <input type="text" name="search_CONTAIN_username" value="${search_CONTAIN_username[0]}"/></label>
...
<table id="pagedTable" border="0" cellpadding="0" cellspacing="0" class="ls_tb">
  ...
  <tr class="ls_table_th">
    ...
    <th class="ls_th_sort"><span class="ls_sort" pagesort="username"><s:message code="user.username"/></span></th>
    <th class="ls_th_sort"><span class="ls_sort" pagesort="logins"><s:message code="user.logins"/></span></th>
    <th class="ls_th_sort"><span class="ls_sort" pagesort="creationDate"><s:message code="user.creationDate"/></span></th>
    <th class="ls_th_sort"><span class="ls_sort" pagesort="lastLoginDate"><s:message code="user.lastLoginDate"/></span></th>
  </tr>
  </thead>
  <tbody>
