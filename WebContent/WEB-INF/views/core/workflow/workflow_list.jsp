...
<div class="c_bar">
  <span class="c_position"><s:message code="workflow.management"/> - <s:message code="list"/></span>
...
<form action="list.do" method="get">
    ...
    <legend><s:message code="search"/></legend>
	  <label class="c_lab"><s:message code="workflow.name"/>: <input type="text" name="search_CONTAIN_name" value="${search_CONTAIN_name[0]}"/></label>
...
<table id="pagedTable" border="0" cellpadding="0" cellspacing="0" class="ls_tb">
  ...
  <tr class="ls_table_th">
    ...
    <th class="ls_th_sort"><span class="ls_sort" pagesort="name"><s:message code="workflow.name"/></span></th>
  </tr>
  </thead>
  <tbody>
