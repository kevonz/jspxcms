...
public class QWorkflow extends EntityPathBase<Workflow> {
    ...
    public final SetPath<WorkflowStep, QWorkflowStep> steps = this.<WorkflowStep, QWorkflowStep>createSet("steps", WorkflowStep.class, QWorkflowStep.class, PathInits.DIRECT);
