...
public abstract class ForeContext {
	...
	public static void setData(Map<String, Object> data, Site site, String url) {
	...
	public static void setData(Map<String, Object> data, Site site,
			HttpServletRequest request) {
		String url = getCurrentUrl(request);
		setData(data, site, url);
	}
